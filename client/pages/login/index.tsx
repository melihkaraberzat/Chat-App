...
const index = () => {
  ...
  return (
    <div className='flex items-center justify-center min-w-full min-h-screen h-14 bg-gradient-to-r from-sky-500 to-indigo-500' >
      <form className='flex flex-col md:w-1/5'>
        <div className='text-3xl font-bold text-center'>
          <span className='text-blue'>Hoşgeldiniz!</span>
        </div>
        <input
          placeholder='email'
        ...
        <a href='http://localhost:3000/signup' className=''>Kaydolmak için tıklayın</a>
      </form>
    </div>
  )
}
